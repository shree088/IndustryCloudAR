...
namespace SampleXamarin
{
    internal class AnchorVisual
    {
        ...
        public AnchorVisual(ArFragment arFragment, CloudSpatialAnchor cloudAnchor, AzureSpatialAnchorsCoarseRelocActivity activity)
            ...
            if (material != null)
            {
                ...
                switch (shape)
                {
                    ...
                    case NamedShape.Cylinder:
                        ...
                        builder.SetSource(this.ArFragment.Context, Resource.Raw.fox_face);
                        ...
                        //method.Invoke(builder, this.activity, Resource.Raw.fox_face);
